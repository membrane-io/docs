...
That program uses the <a href="https://www.membrane.io/share/membrane/height" target="_blank">height package</a>, which simplifies interacting with Height's API. Feel free to fork the program! Or if you'd like to set up something similar for a different tool (e.g. <a href="https://linear.app" target="_blank">Linear</a>), reach out to us <a href="https://discord.gg/4RHyJDV8kj" target="_blank">on Discord</a>—we'd be happy to help.
