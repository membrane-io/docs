...
Any Membrane program can _emit_ and _subscribe to_ events.

For example, if you have a program that handles GitHub webhooks, your program could emit a `webhookReceived` event, and another program that forwards GitHub notifications to Slack could subscribe to that event.
