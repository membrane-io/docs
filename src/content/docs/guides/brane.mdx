...
- Right-clicking on [log entries](https://docs.membrane.io/concepts/observability#_top) and selecting "Add to Brane"
...
| **Edit**           | Creates, modifies, and views files in programs              |
| **MultiEdit**      | Applies multiple edits to a file at once                    |
| **Read**           | Reads file contents with optional line ranges               |
| **Write**          | Writes content to files in programs                         |
| **List**           | Lists programs in workspace or files in a program           |
| **SearchText**     | Searches for text patterns across program files             |
| **SearchGraph**    | Searches across all programs, types, and data in your graph |
| **GetDiagnostics** | Retrieves error and warning information for programs        |
| **TodoWrite**      | Manages todo items and task lists                           |
| **Task**           | Delegates complex tasks to specialized sub-agents           |
| **MembraneManual** | Accesses Membrane documentation                             |
...
Brane accesses your active program and any highlighted code fragments.

**Can Brane execute actions in my Membrane graph?**

Yes, with your permission. Brane will ask for approval before executing any actions, unless explicitly always allowed.
