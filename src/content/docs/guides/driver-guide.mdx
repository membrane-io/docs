...
We have drivers for popular APIs like <Package name="membrane/github" /> and <Package name="membrane/slack" />. Check out the [full list here](https://www.membrane.io/share/membrane). Drivers are open
...
<aside>
  💡 We are working on a way to speed up the driver development process by
  generating drivers using LLM’s and API specs.
</aside>
