Although memconfig.json is auto-generated by the Navigator schema configuration, there are some aspects of the file that can only be modified from within the file itself.
