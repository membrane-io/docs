...
All Membrane programs are capable of sending and receiving emails. Similar to [HTTP endpoints](/features/endpoints/), all you need to do is export an `email` function from the root of your program and use the program's unique email address.
